...
// Copyright (c) 2018 The Bitmonk developers
...
const string strMessageMagic = "Bitmonk Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1){
      ...
      nSubsidy = 75 * COIN;
    } else if (nHeight > 150000 && nHeight <= 210000) {
      nSubsidy = 50 * COIN;
    } else if (nHeight > 210000 && nHeight <= 510000) {
      nSubsidy = 25 * COIN;
    } else if (nHeight > 510000 && nHeight <= 1000000) {
      nSubsidy = 10 * COIN;
    } else {
      nSubsidy = 0 * COIN;
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if (nBestHeight >= 15000 && nBestHeight <= 20000) {
      nSubsidy = 8 * COIN; //for tests
    } if (nBestHeight > 20000 && nBestHeight <= 50000) {
      nSubsidy = 800 * COIN;
    } else if (nBestHeight > 50000 && nBestHeight <= 100000) {
      nSubsidy = 3900 * COIN;
    } else if (nBestHeight > 100000 && nBestHeight <= 130000) {
      nSubsidy = 1400 * COIN;
    } else if (nBestHeight > 130000 && nBestHeight <= 150000) {
      nSubsidy = 700 * COIN;
    } else if (nBestHeight > 150000 && nBestHeight <= 210000) {
      nSubsidy = 350 * COIN;
    } else if (nBestHeight > 210000 && nBestHeight <= 510000) {
      nSubsidy = 140 * COIN;
    } else if (nBestHeight > 510000 && nBestHeight <= 1000000) {
      nSubsidy = 70 * COIN;
