...
static const int64_t STATIC_POS_REWARD = 3.5 * COIN; //Constant reward of 3.5 BMO per COIN
static const int64_t TARGET_SPACING = 60; // 1 min per Block
static const int64_t TARGET_SPACING2 = 60; // 1 min per Block
...
static const unsigned int DEFAULT_MAX_ORPHAN_BLOCKS = 950;
