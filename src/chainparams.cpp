...
public:
	CMainParams() {
		...
		const char* pszTimestamp = "BITMONK_THE_WORLD_IS_YOURS_V_1";
		...
		vout.resize(1);
		vout[0].SetEmpty();
		CTransaction txNew(1, 1534753173, vin, vout, 0);
		genesis.vtx.push_back(txNew);
		genesis.hashPrevBlock = 0;
		genesis.hashMerkleRoot = genesis.BuildMerkleTree();
		genesis.nVersion = 1;
		genesis.nTime = 1534753173;
		genesis.nBits = 0x1e0ffff0;
		genesis.nNonce = 821174;
        ...
        assert(genesis.hashMerkleRoot == uint256("0x3c1d02240857a9de081509b4d050f947ad868b5bc7bce26040d4ec497bb0b129"));
        assert(hashGenesisBlock == uint256("0x00002c41c64568ee933fcda2fb8a7ed2fb89d8e2bdbed64ef96dfdca63d27c92e728"));
		...
		vSeeds.push_back(CDNSSeedData("0", "138.68.81.193"));
		vSeeds.push_back(CDNSSeedData("1", "178.128.111.124"));
		vSeeds.push_back(CDNSSeedData("2", "207.154.210.39"));
