...
int nAnonymizeBitmonkAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Bitmonk
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Bitmonk
    // Mac: ~/Library/Application Support/Bitmonk
    // Unix: ~/.Bitmonk
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bitmonk";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Bitmonk.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "bitmonkd.pid"));
